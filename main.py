...
def ai():
    ...
    logistic_ai_model = model.train_model(logistic_train_data, logistic_x_labels, logistic_y_label,
                                          logistic_ai_model)
...
def visualize():
    ...
    visualization.show(preprocessing.processed_tsunami_train,
                       "earthquake magnitude",
                       ["tsunami magnitude", "water height"])
